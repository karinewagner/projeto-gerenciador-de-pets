  ...
  return (
    <main className="max-w-[1200px] mx-auto w-full px-4 md:px-10 py-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-4">
        ...
        <a href="/" className="inline-flex items-center gap-2 text-[#1b170d] dark:text-white font-semibold text-sm bg-white dark:bg-[#2d271a] px-4 py-2 rounded-lg border border-[#3a3428] hover:bg-[#f3efe7] dark:hover:bg-[#3a3428] transition-colors w-fit">
